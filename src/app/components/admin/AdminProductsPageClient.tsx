...
export default function AdminProductsPageClient({ products }) {
  const [currentPage, setCurrentPage] = useState(1)
  const [selectedCategory, setSelectedCategory] = useState('Alla')

  const productsPerPage = 5

  // Fasta kategorier (eller byt till dynamiska om du hellre vill)
  const categories = ['Alla', 'rings', 'necklaces', 'bracelets', 'earrings', 'stones', 'others']
